...
scp camera.yaml tb310@10.42.0.110:/home/tb310/catkin_ws/src/turtlebot3_autorace/turtlebot3_autorace_camera/calibration/camera_calibration &
...
ssh tb310@10.42.0.110 'source /opt/ros/kinetic/setup.bash && export ROS_MASTER_URI=http://10.42.0.1:11311 && export ROS_HOSTNAME=10.42.0.110 && source ~/catkin_ws/devel/setup.bash && ~/catkin_ws/src/tb3_shell_scripts/./instrinsic_camera.sh' &
